...
const NewsLetter = () => {
  return (
    <div className="lg:max-w-[1520px] m-auto text-white px-4 bg-[#24262b]">
      <div className="mx-auto grid lg:grid-cols-3">
        ...
        <div className="my-4">
          <div className="flex flex-col sm:flex-row items-center justify-between w-full">
            ...
            />
            <button
              className="bg-green-700 text-white rounded-md font-medium w-[200px]
            ml-4 my-6 px-6 py-3 border-none"
            >
              Notify Me
            </button>
          </div>
