...
const Delivery = () => {
  return (
    <div className="lg:w-full  bg-white py-16 px-4">
      <h3 className="text-green-600 font-bold text-[16px] md:text-[18px] lg:text-2xl text-center ">
        Quick Delivery App
      </h3>
      <div className=" mx-auto grid md:grid-cols-2">
        ...
        <div className="flex flex-col justify-center">
          ...
          <h1 className="md:text-3xl sm:text-2xl text-[16px] font-bold py-2">
          ...
          <button
            className="bg-black text-[#00df9a] w-[200px] rounded-md
